    ...
    <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-20 pt-24 pb-16 relative overflow-hidden">
      ...
      <div className="max-w-4xl">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black leading-[1.05] tracking-tight text-stone-100 mb-8">
          Sites que<br />
          <span className="text-amber-500">vendem.</span><br />
          Entrega que<br />
          impressiona.
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a
            ...
            className="inline-flex items-center justify-center gap-3 bg-amber-600 hover:bg-amber-500 text-stone-950 font-bold text-base px-8 py-4 transition-colors duration-200"
          >
          ...
          <a
            href="#portfolio"
            className="inline-flex items-center justify-center gap-2 border border-stone-700 hover:border-amber-600 text-stone-300 hover:text-amber-500 font-medium text-base px-8 py-4 transition-colors duration-200"
          >
            Ver portfólio
