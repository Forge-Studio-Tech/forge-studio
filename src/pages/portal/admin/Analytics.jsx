...
export default function AdminAnalytics() {
  ...
  return (
    <div>
      ...
      <p className="text-portal-muted text-sm mb-8">Tráfego e comportamento dos sites</p>
      ...
      {loading ? (
        ...
        <div className="bg-portal-surface border border-portal-border rounded-xl p-8 text-center">
          <p className="text-portal-muted text-sm">Nenhum projeto com Google Analytics configurado.</p>
          <p className="text-portal-muted text-xs mt-2">Configure o GA Property ID no projeto para ativar.</p>
        </div>
      ) : (
...
function SiteCard({ site, isExpanded, onToggle, onRefresh }) {
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-portal-muted text-xs">{site.client_name} — {site.url?.replace(/^https?:\/\//, '')}</p>
          </div>
